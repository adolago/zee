...
from stanley.api.routers.search import get_vector_store, VectorStoreError

# Setup Logger for capturing logs
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("stanley.api.routers.search")
...
def client(caplog):
    ...
    # Capture logs
    caplog.set_level(logging.ERROR, logger="stanley.api.routers.search")
