...
# stanley.api.main_new creates 'app = create_app()' at module level.
...
from stanley.api.auth.config import AuthSettings
...
def test_app_fails_closed_without_auth_config():
    ...
    if "STANLEY_AUTH_JWT_SECRET_KEY" in os.environ:
