...
class TestMarketRouter:
    ...
    def test_get_market_data(self, client, mock_container):
        ...
        with patch(
            "stanley.api.routers.base.get_app_state", return_value=mock_container
        ):
            with patch(
                "stanley.api.routers.market.get_app_state", return_value=mock_container
            ):
...
class TestPortfolioRouter:
    ...
    def test_portfolio_analytics_with_auth(self, client, auth_headers, mock_container):
        ...
        with patch(
            "stanley.api.routers.portfolio._get_portfolio_analyzer",
...
class TestAnalyticsRouter:
    ...
    def test_money_flow_endpoint(self, client, mock_container):
        ...
        with patch(
            "stanley.api.routers.analytics.get_app_state", return_value=mock_container
        ):
            response = client.post(
...
class TestResearchRouter:
    ...
    def test_research_report_endpoint(self, client, mock_container):
        ...
        with patch(
            "stanley.api.routers.research.get_research_analyzer",
...
class TestOptionsRouter:
    ...
    def test_options_flow_endpoint(self, client, mock_container):
        ...
        with patch(
            "stanley.api.routers.options.get_options_analyzer",
...
class TestETFRouter:
    ...
    def test_etf_flows_endpoint(self, client, mock_container):
        ...
        with patch(
            "stanley.api.routers.etf.get_etf_analyzer",
...
class TestNotesRouter:
    ...
    def test_list_notes_endpoint(self, client, mock_container):
        ...
        with patch(
            "stanley.api.dependencies.get_note_manager",
