...
from stanley.api.routers.bonds import get_analyzer, get_provider, get_screener
from stanley.bonds import (
    BondReference,
    BondScreenResponse,
    BondSummary,
...
def client():
    ...
    import stanley.api.routers.bonds as bonds_module
...
class TestBondsHealthEndpoint:
    ...
    def test_health_returns_healthy_with_provider(self, client, mock_provider):
        ...
        with patch(
            "stanley.api.routers.bonds.get_provider",
