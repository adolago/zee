...
from stanley.api.routers import bonds, search
from stanley.data.providers.terrapin_provider import TerrapinError
from stanley.search import VectorStoreError

# Ensure secret key is set before importing app (if not already set)
if "STANLEY_AUTH_JWT_SECRET_KEY" not in os.environ:
