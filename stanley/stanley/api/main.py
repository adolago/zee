...
from stanley.api.main_new import app, run_dev_server

# Also re-export helpers if they were present in the old main
from stanley.api.utils import create_response, get_timestamp

logger = logging.getLogger(__name__)

warnings.warn(
    "Importing from 'stanley.api.main' is deprecated. Use 'stanley.api.main_new' instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
# This ensures that when tests patch `stanley.api.main.app_state`,
...
# For production, you should use `stanley.api.main_new` directly.
