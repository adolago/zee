"""
Base Strategy Classes for Stanley-NautilusTrader Integration

Provides common functionality for all Stanley trading strategies:
- Position sizing with risk management
- Stop loss and take profit handling
- Signal tracking from Stanley actors
...
class StanleyStrategyConfig(StrategyConfig if NAUTILUS_AVAILABLE else object):
    """
    Base configuration for all Stanley strategies.
...
class StanleyStrategy(Strategy if NAUTILUS_AVAILABLE else object):
    """
    Base class for Stanley trading strategies.

    Provides common functionality:
    - Position sizing based on account equity
    - Entry price tracking for P&L calculation
    - Stop loss and take profit management
    - Signal caching from Stanley actors
    """

    def __init__(self, config: StanleyStrategyConfig):
