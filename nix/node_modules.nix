{
  ...
  bunOs ? (if stdenvNoCC.hostPlatform.isLinux then "linux" else throw "Unsupported platform"),
  rev ? "dirty",
  hash ?
...
let
  packageJson = lib.pipe ../packages/zee-core/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
in
stdenvNoCC.mkDerivation {
  pname = "zee-node_modules";
