...
async function scrapeExams() {
  ...
  if (!EMAIL || !PASSWORD) {
    console.error("Error: TUWEL_EMAIL and TUWEL_PASSWORD environment variables must be set.")
    process.exit(1)
  }
  ...
  try {
    ...
    if (
      contentAfterLogin.includes("2FA") ||
      contentAfterLogin.includes("Zwei-Faktor") ||
