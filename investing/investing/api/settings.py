...
SETTINGS_DIR = Path.home() / ".zee/investing"
SETTINGS_FILE = SETTINGS_DIR / "settings.json"
CONFIG_FILE = Path(__file__).parent.parent.parent / "config" / "investing.yaml"
...
class ApiConnectionSettings(BaseModel):
    ...
    base_url: str = Field(
        default=os.environ.get("ZEE_INVESTING_API_URL", "http://localhost:8000"),
...
class SettingsManager:
    ...
    def get_server_config(self) -> Dict[str, Any]:
        """Get server configuration from investing.yaml."""
