"""
Investing Authentication Module
=============================

Comprehensive authentication and authorization system for the Investing
...
Optional (with defaults):
    ...
    JWT_ALGORITHM=HS256
    JWT_ISSUER=investing-api
    JWT_AUDIENCE=investing-client
...
1. Protecting an endpoint with authentication::
    ...
    from investing.api.auth import get_current_user, AuthUser
...
2. Requiring specific roles::
    ...
    from investing.api.auth import require_roles, Role
...
3. Creating JWT tokens::
    ...
    from investing.api.auth import create_token_pair
...
4. API key management::
    ...
    from investing.api.auth import get_api_key_manager, APIKeyScope
...
5. Password hashing::
    ...
    from investing.api.auth import hash_password, verify_password
...
Author: Investing Development Team
Version: 0.2.0
"""
...
from investing.api.auth.config import (
    AuthSettings,
    RateLimitSettings,
    get_auth_settings,
...
from investing.api.auth.rate_limit import (
    RateLimiter,
    RateLimitMiddleware,
    RateLimitExceeded,
    RateLimitConfig,
...
from investing.api.auth.rbac import (
    Permission,
...
from investing.api.auth.dependencies import (
...
def _get_password_utils():
    from investing.api.auth.passwords import (
        PasswordPolicy,
        hash_password,
        verify_password,
...
from investing.api.auth.models import (
    # Database models
    User,
    APIKey,
    # User schemas
