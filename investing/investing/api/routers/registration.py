...
def register_routers(app: FastAPI) -> None:
    ...
    try:
        from investing.api.routers.system import router as system_router
    ...
    # Settings routes
    try:
        from investing.api.settings import router as settings_router
    ...
    router_modules = [
        ("investing.api.routers.market", "market"),
        ("investing.api.routers.portfolio", "portfolio"),
        ("investing.api.routers.analytics", "analytics"),
        ("investing.api.routers.research", "research"),
        ("investing.api.routers.prediction_markets", "prediction_markets"),
        ("investing.api.routers.options", "options"),
        ("investing.api.routers.etf", "etf"),
        ("investing.api.routers.notes", "notes"),
        ("investing.api.routers.commodities", "commodities"),
        ("investing.api.routers.macro", "macro"),
        ("investing.api.routers.accounting", "accounting"),
        ("investing.api.routers.signals", "signals"),
        ("investing.api.routers.institutional", "institutional"),
        ("investing.api.routers.bonds", "bonds"),
        ("investing.api.routers.news", "news"),
        ("investing.api.routers.search", "search"),
    ]
