...
from investing.api.utils import is_debug_mode, sanitize_error, sanitize_log_input
...
async def get_system_metrics(request: Request) -> ApiResponse:
    ...
    """
    try:
        from investing.core.circuit_breaker import get_all_circuit_breaker_stats
        from investing.core.health import get_health_monitor
