"""
Investing API Router Base Utilities
...
from investing.api.request_context import get_current_app_state
from investing.api.utils import sanitize_error
...
def get_app_state():
    ...
    Prefer the request-scoped state set by middleware in `investing.api.main_new`.
