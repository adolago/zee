"""
Investing Plugin System

A comprehensive plugin architecture for extending Investing's functionality
...
Usage:
------
    from investing.plugins import PluginManager, IndicatorPlugin
