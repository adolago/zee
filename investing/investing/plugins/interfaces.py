...
Provides abstract base classes and protocols for all Investing plugins.
...
class PluginType(Enum):
    """Types of plugins supported by Investing."""
...
class PluginMetadata:
    ...
    min_stanley_version: str = "0.1.0"  # Minimum Investing version
...
class BasePlugin(ABC):
    """
    Abstract base class for all Investing plugins.
