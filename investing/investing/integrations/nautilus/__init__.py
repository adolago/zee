"""
NautilusTrader Integration for Investing

Provides Actors, Indicators, and Data Clients that integrate Investing's
...
from investing.integrations.nautilus.config import (
    OpenBBDataClientConfig,
...
if _HAS_NAUTILUS:
    from investing.integrations.nautilus.indicators import (
        SmartMoneyIndicator,
        InstitutionalMomentumIndicator,
    )
    from investing.integrations.nautilus.data_client import (
        OpenBBDataClient,
        OpenBBLiveDataClient,
    )
    from investing.integrations.nautilus.data_types import (
        OpenBBBarConverter,
