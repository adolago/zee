...
A trading strategy that combines Investing's institutional analytics
...
class InstitutionalMomentumStrategyConfig(InvestingStrategyConfig):
    """
...
class InstitutionalMomentumStrategy(InvestingStrategy):
    """
    ...
    def on_event(self, event: Any) -> None:
        """
        Handle custom events from Investing actors.
