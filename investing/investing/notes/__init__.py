...
Example usage:
    ...
    manager = NoteManager("~/Documents/InvestingVault")
...
class NoteManager:
    """
    High-level interface for the Investing notes system.
    ...
    def __init__(self, vault_path: str = None):
        ...
        Args:
            vault_path: Path to the vault directory.
                       Defaults to ~/.investing/vault
        """
        from pathlib import Path

        if vault_path is None:
            vault_path = Path.home() / ".zee/investing" / "vault"
