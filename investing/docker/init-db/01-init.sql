-- Investing Database Initialization Script
...
-- Grant permissions to investing user
GRANT ALL PRIVILEGES ON SCHEMA market_data TO investing;
GRANT ALL PRIVILEGES ON SCHEMA institutional TO investing;
GRANT ALL PRIVILEGES ON SCHEMA portfolio TO investing;
GRANT ALL PRIVILEGES ON SCHEMA research TO investing;
GRANT ALL PRIVILEGES ON SCHEMA signals TO investing;
...
DO $$
BEGIN
    RAISE NOTICE 'Investing database initialized successfully';
END $$;
