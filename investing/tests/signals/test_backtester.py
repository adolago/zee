...
try:
    from investing.signals import Backtester
    from investing.signals.backtester import (
        BacktestConfig,
        BacktestResult,
        Trade,
        PerformanceMetrics,
...
pytestmark = pytest.mark.skipif(
    not HAS_SIGNALS_MODULE, reason="investing.signals module not yet implemented"
)
...
class TestBacktesterInit:
    ...
    def test_init_with_signal_generator(self, mock_data_manager):
        ...
        from investing.signals import SignalGenerator
