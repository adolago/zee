import os
import pytest
from investing.api.auth.jwt import JWTSettings, get_jwt_settings
from investing.api.auth.config import get_auth_settings, clear_settings_cache
...
def test_jwt_settings_rejects_weak_key_via_env_var():
    ...
    os.environ["ZEE_INVESTING_AUTH_JWT_SECRET_KEY"] = weak_key
...
def test_jwt_settings_accepts_strong_key():
    ...
    os.environ["ZEE_INVESTING_AUTH_JWT_SECRET_KEY"] = strong_key
