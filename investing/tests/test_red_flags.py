...
from investing.accounting.red_flags import (
    RedFlag,
    RedFlagSeverity,
    RedFlagCategory,
    RedFlagReport,
...
class TestRedFlagScorer:
    ...
    def test_init(self):
        """Test initialization."""
        with patch("investing.accounting.red_flags.EdgarAdapter"):
            with patch("investing.accounting.red_flags.FinancialStatements"):
                with patch("investing.accounting.red_flags.FootnoteAnalyzer"):
