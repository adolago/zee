...
Target: 80%+ coverage for investing/commodities/ module.
"""
...
from investing.commodities import (
    CommoditiesAnalyzer,
    CommoditySummary,
    MacroLinkage,
...
class TestCommoditiesAnalyzerInternals:
    ...
    async def test_calculate_relative_strength_single_commodity(self):
        ...
        with patch(
            "investing.commodities.commodities_analyzer.get_commodities_by_category"
        ) as mock_get:
