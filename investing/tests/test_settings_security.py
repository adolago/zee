...
from investing.api.settings import UserSettings, DataSourceSettings, DataSourceConfig, REDACTED_MASK
...
def test_data_sources_security(client):
    ...
    with patch("investing.api.settings.settings_manager.load", return_value=mock_settings) as mock_load, \
         patch("investing.api.settings.settings_manager.save") as mock_save:
