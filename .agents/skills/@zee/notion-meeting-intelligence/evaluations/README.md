...
Evaluation scenarios for testing the Meeting Intelligence skill across different assistant models.
...
- Adds Zee context (industry benchmarks, best practices)
