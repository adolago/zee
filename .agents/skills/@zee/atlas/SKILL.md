...
export ATLAS_CLI="$ZEE_HOME/skills/atlas/scripts/atlas_cli.py"
```
...
Read `references/atlas-data.md` in the skill folder (for example, `$ZEE_HOME/skills/atlas/references/atlas-data.md`) when adjusting data paths or timestamps.
