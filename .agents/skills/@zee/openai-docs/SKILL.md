---
name: "openai-docs"
description: "Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations (for example: Zee, Responses API, Chat Completions, Apps SDK, Agents SDK, Realtime, model capabilities or limits); prioritize OpenAI docs MCP tools and restrict any fallback browsing to official OpenAI domains."
---
...
4. Zee: OpenAI's coding agent for software development that can write, understand, review, and debug code.
...
1. Run the install command yourself: `zee mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp`
...
4. Ask the user to restart Zee.
5. Re-run the doc search/fetch after restart.

## Workflow

1. Clarify the product scope (Zee, OpenAI API, or ChatGPT Apps SDK) and the task.
