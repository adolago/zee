...
version: 1.0.0
author: steipete
tags: [food, ordering, delivery]
source: clawhub
homepage: https://ordercli.sh
metadata: {"clawhub":{"id":"steipete/food-order","requires":{"bins":["ordercli"]},"install":[{"id":"go","kind":"go","module":"github.com/steipete/ordercli/cmd/ordercli@latest","bins":["ordercli"],"label":"Install ordercli (go)"}]}}
---
