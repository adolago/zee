...
Evaluation scenarios for testing the Spec to Implementation skill across different assistant models.
...
- Creates tasks that Zee can implement with clear acceptance criteria
