...
summary: Machine-checked security models for Zee’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks Zee’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Zee enforces its
...
**What this is not (yet):** a proof that “Zee is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/zee-formal-models](https://github.com/vignesh07/zee-formal-models).
...
```bash
git clone https://github.com/vignesh07/zee-formal-models
cd zee-formal-models
