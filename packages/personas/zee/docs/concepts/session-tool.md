...
- When given a `sessionId`, Zee resolves it to the corresponding session key (missing ids error).
...
- After completion, Zee runs a sub-agent **announce step** and posts the result to the requester chat channel.
