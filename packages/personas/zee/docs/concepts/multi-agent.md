...
available from `~/.zee/skills`. See [Skills: per-agent vs shared](/tools/skills#per-agent-vs-shared-skills).
...
```json5
{
  agents: {
    list: [
      { id: "alex", workspace: "~/zee-alex" },
      { id: "mia", workspace: "~/zee-mia" }
    ]
  },
  bindings: [
...
```json5
{
  agents: {
    list: [
      { id: "chat", name: "Everyday", workspace: "~/zee-chat", model: "anthropic/claude-sonnet-4-5" },
      { id: "opus", name: "Deep Work", workspace: "~/zee-opus", model: "anthropic/claude-opus-4-5" }
    ]
  },
  bindings: [
