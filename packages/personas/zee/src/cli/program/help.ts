...
const EXAMPLES = [
  ["zee channels login --verbose", "Link personal WhatsApp Web and show QR + connection logs."],
  [
...
export function configureProgramHelp(program: Command, ctx: ProgramContext) {
  program
    ...
    .option(
      "--dev",
      "Dev profile: isolate state under ~/.zee-dev, default gateway port 19001, and shift derived ports (browser)",
    )
    .option(
      "--profile <name>",
