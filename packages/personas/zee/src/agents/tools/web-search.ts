...
type WebSearchConfig = NonNullable<ZeeConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: ZeeConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("zee configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://zee-bot.com/tools/web",
  };
}
