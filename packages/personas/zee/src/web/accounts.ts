...
export function listWhatsAppAuthDirs(cfg: ZeeConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ZeeConfig): boolean {
...
function resolveDefaultAuthDir(accountId: string): string {
  ...
  return path.join(resolveOAuthDir(), "whatsapp", safeId);
}
...
export function resolveWhatsAppAuthDir(params: { cfg: ZeeConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ZeeConfig): ResolvedWhatsAppAccount[] {
