//! Investing CLI - Command line interface for Investing trading operations.
//!
...
use investing_core::{
    ...
    serve, ApiResponse, ServerOptions, InvestingRuntime,
};
use std::path::PathBuf;

#[derive(Parser)]
#[command(name = "investing")]
#[command(about = "Investing trading CLI - portfolio and risk management")]
#[command(version)]
struct Cli {
    #[command(subcommand)]
    command: Commands,
...
#[derive(Subcommand)]
enum Commands {
    /// Run the Investing HTTP runtime
    Serve {
        ...
        #[arg(long)]
        port: Option<u16>,
        /// Override the Investing runtime data directory
        #[arg(long)]
    ...
    match cli.command {
        Commands::Serve {
            ...
            let options = ServerOptions {
                ...
                data_dir: data_dir.unwrap_or_else(InvestingRuntime::default_data_dir),
            };
