//! Investing Core - Trading and portfolio management library.
//!
//! This crate provides the core functionality for the Investing trading persona:
//!
...
//!
//! ```rust,no_run
//! use investing_core::portfolio::PortfolioTracker;
//!
//! // Create a tracker (uses default path ~/.zee/investing/portfolio.json)
...
pub use runtime::{
    ...
    InvestingRuntime, TradeStatsResponse,
};
pub use server::{serve, ServerOptions};

/// Error types for investing-core operations.
...
/// Result type for investing-core operations.
