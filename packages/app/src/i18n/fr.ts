export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans zee.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (zee.json) pour les noms de fournisseur/modèle",
