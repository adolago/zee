export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Agent Core",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Agent Core.",
  ...
  "provider.connect.agentCoreZen.line1":
    "Agent Core Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.agentCoreZen.visit.prefix": "Visitez ",
  "provider.connect.agentCoreZen.visit.link": "opencode.ai/zen",
  "provider.connect.agentCoreZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Agent Core.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Agent Core.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans agent-core.json",
  ...
  "dialog.server.description": "Changez le serveur Agent Core auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Agent Core ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Agent Core",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (agent-core.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Agent Core ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Agent Core inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Agent Core",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Agent Core sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Agent Core.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Agent Core",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Agent Core.",
