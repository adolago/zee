export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Agent Core",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Agent Core.",
  ...
  "provider.connect.agentCoreZen.line1":
    "Agent Core Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.agentCoreZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.agentCoreZen.visit.prefix": "Besøg ",
  "provider.connect.agentCoreZen.visit.link": "opencode.ai/zen",
  "provider.connect.agentCoreZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Agent Core.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Agent Core.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i agent-core.json",
  ...
  "dialog.server.description": "Skift hvilken Agent Core-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Agent Core ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Agent Core-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (agent-core.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Agent Core understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Agent Core inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Agent Core",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Agent Core ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Agent Core er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Agent Core starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Agent Core.",
