...
export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigurert i agent-core.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (agent-core.json)",
