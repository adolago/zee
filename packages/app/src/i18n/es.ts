export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Agent Core",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Agent Core.",
  ...
  "provider.connect.agentCoreZen.line1":
    "Agent Core Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.agentCoreZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.agentCoreZen.visit.prefix": "Visita ",
  "provider.connect.agentCoreZen.visit.link": "opencode.ai/zen",
  "provider.connect.agentCoreZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Agent Core.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Agent Core.",
  ...
  "dialog.plugins.empty": "Plugins configurados en agent-core.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Agent Core se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Agent Core ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Agent Core",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (agent-core.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Agent Core no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Agent Core incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Agent Core",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Agent Core en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Agent Core.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Agent Core",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Agent Core.",
