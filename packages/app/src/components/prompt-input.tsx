import { useFilteredList } from "@agent-core/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { getDirectory, getFilename, getFilenameTruncated } from "@agent-core/util/path"
import { useDialog } from "@agent-core/ui/context/dialog"
import { ImagePreview } from "@agent-core/ui/image-preview"
...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const slashCommands = createMemo<SlashCommand[]>(() => {
    ...
    const custom = sync.data.command.map((cmd) => ({
      id: `custom.${cmd.name ?? cmd.id}`,
      trigger: cmd.name ?? cmd.id,
