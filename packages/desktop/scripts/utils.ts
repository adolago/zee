...
export const SIDECAR_BINARIES: Array<{ rustTarget: string; binaryName: string; assetExt: string }> = [
  {
    ...
    binaryName: "zee-darwin-arm64",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-apple-darwin",
    binaryName: "zee-darwin-x64",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-pc-windows-msvc",
    binaryName: "zee-windows-x64",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-unknown-linux-gnu",
    binaryName: "zee-linux-x64",
    assetExt: "tar.gz",
  },
  {
    rustTarget: "aarch64-unknown-linux-gnu",
    binaryName: "zee-linux-arm64",
    assetExt: "tar.gz",
  },
]
...
export async function copyBinaryToSidecarFolder(source: string, target = RUST_TARGET) {
  ...
  const dest = windowsify(`src-tauri/sidecars/zee-cli-${target}`)
