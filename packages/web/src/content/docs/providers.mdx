---
title: Providers
description: Using any LLM provider in Agent Core.
---
...
OpenCode Zen is a list of models provided by the Agent Core team that have been
...
It works like any other provider in Agent Core and is completely optional to use.
...
:::info
Using your Claude Pro/Max subscription in Agent Core is not officially supported by [Anthropic](https://anthropic.com).
:::
...
3. Copy the API key for use in Agent Core.
...
6. **Important**: Before using cloud models in Agent Core, you must pull the model information locally:
...
OpenCode Zen is a list of tested and verified models provided by the Agent Core team. [Learn more](/docs/zen).
