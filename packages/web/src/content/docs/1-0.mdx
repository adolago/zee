...
description: What's new in Zee 1.0.
---

Zee 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same zee server.
...
version. However some older versions of Zee always grab latest.
