...
- Project config: `.agent-core/skills/<name>/SKILL.md`
- Global config: `~/.config/agent-core/skills/<name>/SKILL.md`
...
Global definitions are also loaded from `~/.config/agent-core/skills/*/SKILL.md` and `~/.claude/skills/*/SKILL.md`.
...
Create `.agent-core/skills/git-release/SKILL.md` like this:
