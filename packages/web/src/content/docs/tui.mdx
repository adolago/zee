---
title: TUI
description: Using the Zee terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Zee provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Zee starts the TUI for the current directory.
...
When using the Zee TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Zee. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Zee config file.
