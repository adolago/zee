   ...
   include:
     - component: $CI_SERVER_FQDN/nagyv/gitlab-opencode/opencode@2
       inputs:
         ...
         auth_json: $AGENT_CORE_AUTH_JSON # The variable name for your OpenCode authentication JSON
...
6.  Create a flow config file, here's an example:
    ...
    commands:
      ...
      - mkdir --parents ~/.local/share/agent-core
      - |
        cat > ~/.local/share/agent-core/auth.json << EOF
        {
          "anthropic": {
            "type": "api",
