---
title: Ecosystem
description: Projects and integrations built with Zee.
---

A collection of community projects built on Zee.

:::note
Want to add your Zee related project to this list? Submit a PR.
:::
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using OpenCode via @zee/sdk   |
