...
```bash
export AGENT_CORE_DISABLE_CLAUDE_CODE=1        # Disable all .claude support
export AGENT_CORE_DISABLE_CLAUDE_CODE_PROMPT=1 # Disable only ~/.claude/CLAUDE.md
export AGENT_CORE_DISABLE_CLAUDE_CODE_SKILLS=1 # Disable only .claude/skills
```
