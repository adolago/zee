...
Create `.zee/commands/test.md`:

```md title=".zee/commands/test.md"
---
...
You can add custom commands through the Zee config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Zee [config](/docs/config):

```json title="zee.jsonc" {4-12}
{
...
- Global: `~/.config/zee/commands/`
- Per-project: `.zee/commands/`

```markdown title="~/.config/zee/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".zee/commands/component.md"
---
...
```md title=".zee/commands/create-file.md"
---
...
```md title=".zee/commands/analyze-coverage.md"
---
...
```md title=".zee/commands/review-changes.md"
---
...
```md title=".zee/commands/review-component.md"
---
...
zee includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
