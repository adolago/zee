...
Create `.agent-core/commands/test.md`:

```md title=".agent-core/commands/test.md"
---
...
```json title="agent-core.jsonc" {4-12}
{
...
- Global: `~/.config/agent-core/commands/`
- Per-project: `.agent-core/commands/`

```markdown title="~/.config/agent-core/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".agent-core/commands/component.md"
---
...
```md title=".agent-core/commands/create-file.md"
---
...
```md title=".agent-core/commands/analyze-coverage.md"
---
...
```md title=".agent-core/commands/review-changes.md"
---
...
```md title=".agent-core/commands/review-component.md"
---
