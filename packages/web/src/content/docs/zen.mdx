...
OpenCode Zen is a list of tested and verified models provided by the Agent Core team.

:::note
OpenCode Zen is currently in beta.
:::

Zen works like any other provider in Agent Core. You login to OpenCode Zen and get
...
OpenCode Zen works like any other provider in Agent Core.
