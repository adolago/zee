...
export namespace MessageV2 {
  ...
  export async function toModelMessage(input: WithParts[], model: Provider.Model): Promise<ModelMessage[]> {
    ...
    for (const msg of input) {
      ...
      if (msg.info.role === "assistant") {
        // When the assistant message was generated by a different model/provider,
        // don't send provider-specific metadata as it can cause 400 errors
