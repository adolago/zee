...
export function Tips(props: TipsProps) {
  ...
  return (
    <box flexDirection="column">
      {/* Top border - either custom or default rounded */}
...
export const TIPS = [
  ...
  "Use {highlight}:undo{/highlight} to revert the last message and any file changes made by zee.",
  ...
  "Create {highlight}zee.jsonc{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/zee/zee.jsonc{/highlight} for global config.",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.zee/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.zee/plugin/{/highlight} for event hooks.",
  "Use plugins to send OS notifications when sessions complete.",
  "Create a plugin to prevent zee from reading sensitive files.",
  "Use {highlight}zee run{/highlight} for non-interactive scripting.",
  "Use {highlight}zee run --continue{/highlight} to resume the last session.",
  "Use {highlight}zee run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}zee serve{/highlight} for headless API access.",
  "Use {highlight}zee run --attach{/highlight} to connect to a running server for faster runs.",
  ...
  "Run {highlight}zee debug config{/highlight} to troubleshoot configuration.",
  ...
  "Type {highlight}:q{/highlight} or {highlight}exit{/highlight} to quit zee.",
