...
function computeFlags() {
  return {
    ...
    ZEE_SESSION_FORCE_KILL_GRACE_PERIOD_MS: number("ZEE_SESSION_FORCE_KILL_GRACE_PERIOD_MS"),
    ...
    ZEE_NO_NEW_LEGACY: truthy("ZEE_NO_NEW_LEGACY"),
    ...
    ZEE_RUNTIME_OPENCODE_SURFACES: env("ZEE_RUNTIME_OPENCODE_SURFACES"),
    ZEE_RUNTIME_OPENCODE_FORCE_LEGACY_SURFACES: env("ZEE_RUNTIME_OPENCODE_FORCE_LEGACY_SURFACES"),
    ZEE_RUNTIME_OPENCODE_ALLOW_LEGACY_FALLBACK: env("ZEE_RUNTIME_OPENCODE_ALLOW_LEGACY_FALLBACK"),
