...
export DISPLAY=:1
export HOME=/tmp/zee-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${ZEE_BROWSER_CDP_PORT:-${ZEE_BROWSER_CDP_PORT:-9222}}"
VNC_PORT="${ZEE_BROWSER_VNC_PORT:-${ZEE_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${ZEE_BROWSER_NOVNC_PORT:-${ZEE_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${ZEE_BROWSER_ENABLE_NOVNC:-${ZEE_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${ZEE_BROWSER_HEADLESS:-${ZEE_BROWSER_HEADLESS:-0}}"
