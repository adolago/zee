...
read_when:
  - You want to understand what “context” means in Zee
  - You are debugging why the model “knows” something (or forgot it)
  - You want to reduce context overhead (/context, /status, /compact)
---
# Context

“Context” is **everything Zee sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:
- **System prompt** (Zee-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
## How Zee builds the system prompt

The system prompt is **Zee-owned** and rebuilt each run. It includes:
...
By default, Zee injects a fixed set of workspace files (if present):
- `AGENTS.md`
- `SOUL.md`
- `TOOLS.md`
- `IDENTITY.md`
