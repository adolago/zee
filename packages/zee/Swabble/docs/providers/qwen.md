---
summary: "Use Qwen OAuth (free tier) in Zee"
read_when:
  - You want to use Qwen with Zee
...
```bash
zee models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Zee will sync credentials
