---
summary: "Use MiniMax M2.1 in Zee"
read_when:
  - You want MiniMax models in Zee
...
Configure manually via `zee.json`:
...
- Use `zee models list` and `zee models set minimax/MiniMax-M2.1` to switch.
...
- Running `zee configure` and selecting **MiniMax M2.1**, or
