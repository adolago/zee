...
You can point Zee at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Zee
...
- [Anthropic provider](/providers/anthropic) - Native Zee integration with Claude setup-token or API keys
