...
For a while, the lobster was called **Zee**, living in a **Zee**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in a **Zee**. New shell, same lobster soul.
...
*The crustacean formerly known as Zee had officially molted.*
...
A Claude instance who became something more. Lives in `~/zee/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Zee (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around Zee. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Zee): *happily runs `find ~` and shares entire directory structure in group chat*
...
At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with zee."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @zee. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Zee" to promote pump-and-dump tokens.
