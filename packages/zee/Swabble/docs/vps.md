---
summary: "VPS hosting hub for Zee (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- You connect from your laptop/phone via the **CLI/TUI** or **Tailscale/SSH**.
...
(headless). Nodes provide local `system.run`
