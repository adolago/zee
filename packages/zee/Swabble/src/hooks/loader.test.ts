...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.ZEE_BUNDLED_HOOKS_DIR;
    process.env.ZEE_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      ...
      process.env.ZEE_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
