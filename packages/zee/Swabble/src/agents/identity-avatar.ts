...
function resolveAvatarSource(cfg: ZeeConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ZeeConfig, agentId: string): AgentAvatarResolution {
