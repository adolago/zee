...
const DEFAULT_APPROVAL_REGISTRATION_TIMEOUT_MS = 10_000;
        ...
        if (requiresAsk) {
          ...
          try {
            const registrationResult = await callGatewayTool<{
              ...
              { timeoutMs: DEFAULT_APPROVAL_REGISTRATION_TIMEOUT_MS },
              {
                id: approvalId,
                command: commandText,
                cwd: workdir,
            ...
            if (typeof registrationResult?.expiresAtMs === "number") {
