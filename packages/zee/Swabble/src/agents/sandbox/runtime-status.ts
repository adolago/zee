...
function resolveMainSessionKeyForSandbox(params: { cfg?: ZeeConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: ZeeConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`zee sandbox explain --session ${runtime.sessionKey}`)}`,
  );
