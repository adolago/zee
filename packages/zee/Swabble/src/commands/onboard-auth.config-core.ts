...
export function applyZaiConfig(cfg: ZeeConfig): ZeeConfig {
...
export function applyOpenrouterProviderConfig(cfg: ZeeConfig): ZeeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: ZeeConfig): ZeeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: ZeeConfig): ZeeConfig {
...
export function applyOpenrouterConfig(cfg: ZeeConfig): ZeeConfig {
...
export function applyMoonshotProviderConfig(cfg: ZeeConfig): ZeeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: ZeeConfig): ZeeConfig {
...
export function applyKimiCodeProviderConfig(cfg: ZeeConfig): ZeeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ZeeConfig): ZeeConfig {
...
export function applySyntheticProviderConfig(cfg: ZeeConfig): ZeeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ZeeConfig): ZeeConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ZeeConfig): ZeeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ZeeConfig): ZeeConfig {
