    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["zee status", "Show channel health + session summary."],
          ["zee status --all", "Full diagnosis (read-only)."],
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ...
          ["zee sessions --store ./tmp/sessions.json", "Use a specific session store."],
        ])}\n\n${theme.muted(
