...
const CLIENT_ID_KEYS = [
  "ZEE_GEMINI_OAUTH_CLIENT_ID",
  "ZEE_GEMINI_OAUTH_CLIENT_ID",
  "GEMINI_CLI_OAUTH_CLIENT_ID",
];
const CLIENT_SECRET_KEYS = [
  "ZEE_GEMINI_OAUTH_CLIENT_SECRET",
  "ZEE_GEMINI_OAUTH_CLIENT_SECRET",
...
function resolveOAuthClientConfig(): { clientId: string; clientSecret?: string } {
  ...
  throw new Error(
    "Gemini CLI not found. Install it first: brew install gemini-cli (or npm install -g @google/gemini-cli), or set ZEE_GEMINI_OAUTH_CLIENT_ID.",
  );
}
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to Zee.</p></body></html>",
        );
