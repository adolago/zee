const dir = process.env.ZEE_E2E_PROJECT_DIR ?? process.cwd()
const title = process.env.ZEE_E2E_SESSION_TITLE ?? "E2E Session"
const text = process.env.ZEE_E2E_MESSAGE ?? "Seeded for UI e2e"
const model = process.env.ZEE_E2E_MODEL ?? "zai-coding-plan/glm-4.7"
