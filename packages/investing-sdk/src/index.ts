/**
 * @investing/sdk — TypeScript SDK for Investing Investment Platform
 *
 * Usage:
 *   import { InvestingClient } from "@investing/sdk";
 *
...
// Main client
export { InvestingClient, type InvestingClientConfig } from "./client";
...
export { InvestingDaemon } from "./daemon";
export { InvestingWsClient } from "./ws";
export {
  MemoryBridge,
  type MemoryBackend,
  type MemoryEntry,
