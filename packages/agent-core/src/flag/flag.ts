...
function computeFlags() {
  return {
    ...
    AGENT_CORE_DISABLE_PROJECT_CONFIG: truthyCompat("AGENT_CORE_DISABLE_PROJECT_CONFIG", "OPENCODE_DISABLE_PROJECT_CONFIG"),
    AGENT_CORE_DISABLE_FILETIME_CHECK: truthyCompat("AGENT_CORE_DISABLE_FILETIME_CHECK", "OPENCODE_DISABLE_FILETIME_CHECK"),
