/**
 * Investing Research Scratchpad Tool
 *
...
// State directory: ~/.local/state/zee/investing/scratchpad/
function getScratchpadDir(): string {
  ...
  return path.join(stateDir, "investing", "scratchpad");
}
...
const LogAction = z.object({
  ...
  toolId: z.string().describe("Tool that was called (e.g., zee:invest-market-data)"),
