...
- Same path: run the app from a fixed location (for Zee, `dist/Zee.app`).
...
```bash
sudo tccutil reset Accessibility com.zee.mac
sudo tccutil reset ScreenCapture com.zee.mac
