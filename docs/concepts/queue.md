...
## How it works
- [`src/process/command-queue.ts`](https://github.com/zee/zee/blob/main/src/process/command-queue.ts) holds a lane-aware FIFO queue and drains each lane synchronously.
