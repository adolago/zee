---
summary: "How Zee presence entries are produced, merged, and displayed"
read_when:
...
Implementation: [`src/infra/system-presence.ts`](https://github.com/zee/zee/blob/main/src/infra/system-presence.ts) (`initSelfPresence()`).
...
Implementation: [`src/gateway/server.ts`](https://github.com/zee/zee/blob/main/src/gateway/server.ts) (connect handling uses `connect.params.client.instanceId` when provided; otherwise falls back to `connId`).
...
Implementation:
- Gateway: [`src/gateway/server.ts`](https://github.com/zee/zee/blob/main/src/gateway/server.ts) handles method `system-event` by calling `updateSystemPresence(...)`.
- mac app beaconing: [`apps/macos/Sources/Zee/PresenceReporter.swift`](https://github.com/zee/zee/blob/main/apps/macos/Sources/Zee/PresenceReporter.swift).
...
Implementation: [`src/gateway/server.ts`](https://github.com/zee/zee/blob/main/src/gateway/server.ts) (node bridge handlers + timer beacons).
...
Implementation: [`src/infra/system-presence.ts`](https://github.com/zee/zee/blob/main/src/infra/system-presence.ts) (`normalizePresenceKey()`).
...
Implementation: [`apps/macos/Sources/Zee/InstanceIdentity.swift`](https://github.com/zee/zee/blob/main/apps/macos/Sources/Zee/InstanceIdentity.swift).
...
Implementation: [`src/infra/system-presence.ts`](https://github.com/zee/zee/blob/main/src/infra/system-presence.ts) (`TTL_MS`, `MAX_ENTRIES`, pruning in `listSystemPresence()`).
...
Implementation: [`src/gateway/server.ts`](https://github.com/zee/zee/blob/main/src/gateway/server.ts) (`isLoopbackAddress()`).
...
Implementation:
- View: [`apps/macos/Sources/Zee/InstancesSettings.swift`](https://github.com/zee/zee/blob/main/apps/macos/Sources/Zee/InstancesSettings.swift)
- Store: [`apps/macos/Sources/Zee/InstancesStore.swift`](https://github.com/zee/zee/blob/main/apps/macos/Sources/Zee/InstancesStore.swift)
