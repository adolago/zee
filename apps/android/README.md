## Zee Node (Android) (internal)

Modern Android node app: connects to the **Gateway-owned bridge** (`_zee-bridge._tcp`) over TCP and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm zee gateway --port 18789 --verbose
```
