...
public enum ZeeCanvasA2UICommand: String, Codable, Sendable {
...
public struct ZeeCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ZeeCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
