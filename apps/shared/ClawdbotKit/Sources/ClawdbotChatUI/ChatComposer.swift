...
@MainActor
struct ZeeChatComposer: View {
    @Bindable var viewModel: ZeeChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(ZeeChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(ZeeChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \ZeePendingAttachment.id)
                { (att: ZeePendingAttachment) in
                    HStack(spacing: 6) {
    ...
    private var editor: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(ZeeChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(ZeeChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(ZeeChatTheme.subtleCard)
        .clipShape(Capsule())
    }
