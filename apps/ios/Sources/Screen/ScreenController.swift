...
final class ScreenController {
    ...
    /// Callback invoked when a zee:// deep link is tapped in the canvas
...
/// Handles navigation policy to intercept zee:// deep links from canvas
@MainActor
...
private final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    static let messageName = "zeeCanvasA2UIAction"
